...
const autoStyleClass: AutoStyleClass = 'user-card-as';
import { type PersonType, getFullName } from '@/types/person';
...
<template>
    <div v-if="person" :class="autoStyleClass" class="w-fit h-fit p-6 border rounded-md shadow-md dark:text-white">
...
<!-- TODO: Remove AutoStyles in production. Then Push to prod once family names are on galaxy  -->