...
const autoStyleClass: AutoStyleClass = 'tree-view-settings-sidebar-as';
...
<template>
    <div class="absolute top-1/2 transform -translate-y-[42vh] left-6 flex flex-col rounded-md p-2 bg-white dark:bg-zinc-950 border-2 hover:border-zinc-300 dark:border-zinc-600 dark:hover:border-zinc-100 z-30" :class="autoStyleClass">
