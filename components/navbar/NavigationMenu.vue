            ...
            <NavigationMenuItem class="mr-3">
                ...
                <NavigationMenuContent
                    ...
                    <ul class="one m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[500px] sm:grid-cols-[0.75fr_1fr]">
                        <li class="row-span-3 grid">
                            <NavigationMenuLink as-child>
                                <NuxtLink
                                    ...
                                    <div class="mb-[7px] text-[18px] font-medium leading-[1.2] dark:text-white">Family
                                        Trees</div>
                                    <p class="text-mauve4 text-[14px] leading-[1.3] dark:text-white">Private, Shareable,
                                        and easy to use for the whole family!</p>
                                </NuxtLink>
                            </NavigationMenuLink>
                        </li>
                        ...
                        <li>
                            <NavigationMenuLink as-child>
                                <NuxtLink to="/discover" class="border border-transparent hover:border-zinc-400 dark:hover:border-zinc-50
                                    focus:shadow-[0_0_0_2px] focus:shadow-green7 hover:bg-mauve3 block select-none
                                    rounded-md p-3 text-[15px] leading-none no-underline outline-none hover:outline-none
                                    transition-colors">
                                    <div class="text-black mb-[5px] font-medium leading-[1.2] dark:text-white">
                                        View Your Family Trees
                                    </div>
                                    <p class="text-black dark:text-white my-0 leading-[1.4]">
                                        <span>Search for your family members & discover your roots now!</span>
                                        <span class="inline-block">
                                            <Icon icon="radix-icons:chevron-right" class="pt-1" />
                                        </span>
                                    </p>
                                </NuxtLink>
                            </NavigationMenuLink>
