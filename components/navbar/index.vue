...
<template>
    ...
    >
        <div class="flex items-center justify-evenly rounded-md p-3 w-full">
            <NuxtLink to="/" class="w-fit min-w-[420px]">
                <!-- <NuxtImg src="/my-trees-logo-with-name.png" class="cursor-pointer rounded-md hover:shadow-md" height="99" /> -->
                <h2 class="text-3xl font-extralight text-zinc-950 dark:text-zinc-200">MyTrees.Family</h2>
            </NuxtLink>
            <!-- 
                TODO: 
                Create a position fixed NuxtLink that sits on top of the current MyTrees.Family and use  MyTrees.{{ displayText }}. 
                This is to fix the width issue. 
            -->
            <NavigationMenu />
            <ThemeToggler />
        </div>
