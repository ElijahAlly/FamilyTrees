...
import { getFullName, getGenderLabel } from '@/types/person';
import { useBannerStore } from '@/stores/useBannerStore';

const autoStyleClass: AutoStyleClass = '[person-id]-as';
...
<template>
  <div v-if="person" :class="autoStyleClass" class="min-h-screen w-full p-4">
